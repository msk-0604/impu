  ...
  return (
    <section className="px-5 py-12 md:px-10 md:py-18">
      <div className="mx-auto w-full max-w-6xl">
        <SectionTitle eyebrow="USAGE SCENES" title="こんな時におすすめ" />
          ...
          {usageScenes.map((scene) => (
            ...
            >
              ...
              <div className="space-y-2 p-5">
                <h3 className="text-base font-semibold text-[#2f241d] md:text-lg">{scene.title}</h3>
                <p className="text-sm leading-7 text-[#59483b]">{scene.description}</p>
              </div>
            </article>
          ))}
        </div>
