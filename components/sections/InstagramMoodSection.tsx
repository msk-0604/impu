    ...
    <section className="px-5 py-12 md:px-10 md:py-18">
      <div className="mx-auto w-full max-w-6xl">
        <SectionTitle
          ...
          description="最新の営業日、季節のお菓子、売り切れ情報まで。Instagramで流れてしまう情報を、見やすく整理します。"
        />
        <div className="mt-8 grid grid-cols-2 gap-4 md:grid-cols-3 md:gap-6">
          {instagramMoodItems.map((item) => (
            <article
              key={item.id}
              className="overflow-hidden rounded-[24px] border border-[#e8d8ce] bg-[#fffaf3] shadow-[0_12px_28px_rgba(63,45,40,0.08)]"
            >
